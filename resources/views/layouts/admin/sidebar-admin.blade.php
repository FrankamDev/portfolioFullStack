        ...
        <div class="nav-wrapper">
            ...
            <div class="nav-list">
                <ul>
                    ...
                    <li>
                        <a class="{{ (request()->is('admin/abouts')) ? 'nav-active' : '' }}"  href="{{ route('edit-about') }}">
                            <span><i class="fas fa-user"> </i></span>
                            <span>About Me</span>
                        </a>
                    </li>
                    <li>
                        <a  href="service.html" class="{{ (request()->is('/')) ? 'nav-active' : '' }}">
                            <span><i class="fas fa-concierge-bell"> </i></span>
                            <span>Services</span>
                        </a>
                    </li>
                    <li>
                        <a href="skill.html" class="{{ (request()->is('/')) ? 'nav-active' : '' }}">
                            <span><i class="fas fa-lightbulb"> </i></span>
                            <span>Skills</span>
                        </a>
                    </li>
                    <li>
                        <a href="education.html" class="{{ (request()->is('/')) ? 'nav-active' : '' }}">
                            <span><i class="fas fa-graduation-cap"> </i></span>
                            <span>Educations</span>
                        </a>
                    </li>
                    <li>
                        <a  href="experience.html" class="{{ (request()->is('/')) ? 'nav-active' : '' }}">
